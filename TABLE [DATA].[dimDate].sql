--============================================================================================--
-- This script creates the date dimension table and insert date related records from 2000.
-- Ci Zhu
-- 20190106
-- Reference: https://www.mssqltips.com/sqlservertip/4054/creating-a-date-dimension-or-calendar-table-in-sql-server/
--============================================================================================--

-- ===================================================Create basic temp table=============================================--
...
--DROP TABLE DATA.dimDate
INSERT DATA.dimDate WITH (TABLOCKX)
SELECT
